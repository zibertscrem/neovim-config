...
vim.keymap.set("n", "<leader>j", "m1")
vim.keymap.set("n", "<leader>k", "m2")
vim.keymap.set("n", "<leader>l", "m3")
vim.keymap.set("n", "<leader>;", "m4")

vim.keymap.set("n", "<C-j>", "'1")
vim.keymap.set("n", "<C-k>", "'2")
vim.keymap.set("n", "<C-l>", "'3")
